...
export type Tab =
  ...
  | "comptes_externes"
  | "prospection" | "credit_fournisseur"
  | "gps_tracker"
  ...
  | "investissement" | "sourcing" | "pricing"
...
const NAV_GROUPS: NavGroup[] = [
  ...
  // ── COMMERCIAL ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: "secteurs",     label: "Secteurs",           labelAr: "القطاعات",        permKey: "canViewCommercial", icon: <Icon d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0zM15 11a3 3 0 11-6 0 3 3 0 016 0z" /> },
...
const PANELS: Record<Tab, (u: User) => React.ReactNode> = {
  ...
  investissement:        (_u) => <BOInvestissement />,
...
function SidebarContent({
  ...
  return (
    <aside className="flex flex-col h-full bg-white border-r border-slate-200">
      ...
      {/* Brand */}
      <div className={`flex items-center gap-3 px-4 py-3 border-b border-slate-200 ${sidebarCollapsed ? "justify-center px-2 py-3" : ""}`}>
        <div className="w-10 h-10 rounded-xl overflow-hidden flex-shrink-0 bg-white border border-slate-200 shadow-sm">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src={appLogo || "/empire-fresh-logo.png"}
            alt={appName}
